...
const MerchantSuggestionDetail = ({ suggestion }) => {
  return (
      ...
      <Grid container spacing={2}>
        <Grid item sm={3} xs={3}>
          <img
            ...
            src={suggestion?.item?.profile?.profilePicture}
          />
        </Grid>
        ...
        <Grid item sm={12} xs={12}>
          <Link to={{ pathname: suggestion?.item?.profile?.url }}>
            Go to link
          </Link>
        </Grid>
        <Grid
...
MerchantSuggestionDetail.propTypes = {
  // eslint-disable-next-line react/forbid-prop-types
  suggestion: PropTypes.object.isRequired,
};

export default MerchantSuggestionDetail;
